...
import 'package:food_app/page/food/figure_detail.dart';
import 'package:food_app/page/food/popular_figure_detail.dart';
import 'package:food_app/page/food/recommended_figure_detail.dart';
...
class RouteHelper {
  ...
  static String getPopularFigure(int pageId, String page) =>
      '$popularFood?pageId=$pageId&page=$page';
  static String getRecommendedFigure(int pageId, String page) =>
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () {
        var pageId = Get.parameters['pageId'];
        var page = Get.parameters["page"];
        return FigureDetail(pageId: int.parse(pageId!), page: page!);
      },
      transition: Transition.fadeIn,
    ),
    GetPage(
